...
IF merror = 1466
   Faz = 0
   cText = "Servidor de Acesso não Foi encontrado"  + Chr(13) + Chr(13) + ;
           "A Rede não esta acessivel "  + Chr(13) + ;
...
******************************************************
*      Função Identifica permissão de usuários       *
******************************************************
...
if UPPER(ii_soc3) = "SIM"     
        ...
        Thisform.pageframe1.page2.label46.Enabled  = .T. && alterar 2º tela    
endif        
